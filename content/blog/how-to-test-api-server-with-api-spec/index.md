...
![Scree](./Screen-Shot-2015-12-06-at-12.03.57-AM.png)
...
![APIドキュメントでAPIサーバをテストする](./Screen-Shot-2015-12-06-at-1.25.59-AM.png)
...
![APIドキュメントでAPIサーバをテストする](./Screen-Shot-2015-12-06-at-1.27.02-AM.png)
...
![APIドキュメントでAPIサーバをテストする](./Screen-Shot-2015-12-05-at-2.51.19-PM.png)



Apiaryのドキュメントの設定を開き、Githubと連携させる設定をしておきます   

![Scree](./Screen-Shot-2015-12-06-at-1.05.14-AM.png)



Githubのリポジトリの設定を開き、Apiaryを選択します。   

![APIドキュメントでAPIサーバをテストする](./Screen-Shot-2015-12-05-at-2.52.55-PM.png)



domainのところには、Apiaryのドメインを設定します。写真の太字の箇所が入力すべき値です。   

![Scree](./Screen-Shot-2015-12-05-at-2.53.30-PM.png)
