...
WindowsはIEの動作確認にだけ使っており全くセットアップされてない状況で急にWindowsを使うことになったときに必要だったことをまとめます。  
普段使いしているUbuntuで致命的な問題が起こり実用に耐えなくなってしまい急遽IE確認用に残しておいたWindowsを開発機として使うことになったので、次こういうことが起こった時にスムーズに対処できるようにするためのメモです

おそらくWindowsユーザにとって特に目新しいことはないと思います。**そして吟味されていない不適切な方法が掲載されている可能性があります**  
新しいPCが届くまでのつなぎとして雑に設定しているため、もっと良い選択肢があれば教えてもらえると喜びます。  
