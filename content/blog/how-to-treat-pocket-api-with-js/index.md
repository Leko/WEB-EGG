...
![リクエストトークンを取得](./8223fde78c3ee79b98e79042f1607e04.png)
...
![こんな画面](./f91ab41bde5ae5e886c1a19bbcfd53ca.png)
...
(function(global, undefined) {
  ...
  https.get(endpoint + "?" + serialize(param), function(res) {
    var response = "";
    // データを受信したら
...
![Pocketから取得した結果](./aa4012ad6bc2891b4a3bdc99d8ae9c41.png)
