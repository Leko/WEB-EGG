...
![Twitter Widgets](./20130313_step2.jpeg) ウィジェット一覧ページを開いたら、「新規作成」をクリックします。

![step2](./20130313_step3.jpeg) すると、上記画面のように埋め込みタイムラインの設定と、 そのプレビューが表示されると思います。
...
![step3](./20130313_step4.jpeg) すると、おそらく上のような文字が 埋め込みタイムラインのプレビューの下に現れると思います。 これをコピーしておく。
